const qnaList = [
  ...
  {
    q: '스케이트보드 파트라면 역시 음악은',
    a: [
      { answer: '락사운드', score: 1 },
      { answer: '한국 가요', score: 2 },
      { answer: '제즈', score: 3 },
      { answer: '전자음악', score: 4 }
    ]
  },
  {
    ...
    a: [
      ...
      { answer: '속도감 넘치는 힐밤', score: 2 },
      { answer: '월라이드, 슬레피, 본레스.. 뭐든 창의적인거', score: 3 },
      { answer: '롱테이크 중 끝나지 않는 연속 트릭', score: 4 }
    ]
  },
  {
    q: '선호하는 파트 길이는',
  ...
  },
  {
    q: '파트 사이사이에는',
    a: [
      { answer: '위험함과 과감함이! skate or die', score: 1 },
      { answer: '행인들과의 interaction. 싸움이던 응원이던', score: 2 },
      { answer: '영상미, 풍경 삽입, 예술성이지', score: 3 },
      { answer: '창의적이고 멋있는 편집', score: 4 }
    ]
  },
  {
    q: '스케이트보드 파트의 시작과 끝은 역시',
  ...
  },
  {
    q: '파트 사이사이에는',
    a: [
      { answer: '위험함과 과감함이! skate or die', score: 2 },
      { answer: '행인들과의 interaction. 싸움이던 응원이던', score: 3 },
      { answer: '영상미, 풍경 삽입, 예술성이지', score: 4 },
      { answer: '창의적이고 멋있는 편집', score: 4 }
    ]
  }
]
